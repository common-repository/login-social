...
Plugin allows to create easy custom login and registration. With this WordPress login plugin use reCaptcha, pop-up and advanced design options.

== Description ==

= Plugin allows to create easy custom login and registration. With this WordPress login plugin use reCaptcha, pop-up and advanced design options. =

* [Wordpress plugin](https://huge-it.com/wordpress-login/)
* [Demo](https://huge-it.com/wordpress-login-demo-1-login/)
* [FAQ](https://huge-it.com/wordpress-login-faq/)
* [User Manual](https://huge-it.com/wordpress-login-user-manual/)
* [Support](https://huge-it.com/contact-us/)
* [Github Project](https://github.com/Huge-IT/login-social)


Huge-IT has prepared an awesome plugin for managing and simplifying the process of registration and sign in to the website. If you have decided to have social website with a sign up ability the plugin may be used to let visitors enter in your dashboard using a simple and beautifully designed buttons, the Button opens a popup with a nice form which a user fills in and access to his/her account.

If your business is related with the community and your website is social, or you simply has other users in your wordpress, then the button LOG IN and SIGN UP will help your website users to easily sign in and have their own accounts in your site. Having an account in a website gives more advantages to authorized users. It can be the ability to have access to a new material/information/projects which are closed to unregistered users, as well as take part in the creation of topics, submitting comments, posting reviews and other available actions.
...
* Social part of the plugin gives the place to add the application ID and Secret codes to enable ability for sign up and sign in using facebook account
* Design section is for the working on the look of your sign in button and popup, the sign and sign up popup includes Remember Me options, Forget Password, Name , additional name and design of the login and password fields. There may be performed changes from the color and font size, as well as special place for Custom CSS which will allow you to make desirable changes on it’s style.
* Security section is for the protection of your site from a spam and other harming bots, will add reCaptcha settings for the sign up, sing and forgot password form.
...
**Custom Shortcodes.** The shortcode which adds the button for sign and SIGN UP may have custom construction by having extra attributes in it, such as the text/label on the button using text=”Login” you may change the name with other name or other language, or using attribute show_menu=”yes/no” enable or disable the account menu.

**Gravatar Support.** The plugin is supported by a gravatar which is configured in account settings of WordPress, using gravatar you may add the image or integrate it from your Gravatar account.

**Widget Support.** Button for sign in and Sign up may be placed on the widget area of your website on a sidebar, footer or header, by this way it will look compact and convenient for use.  

**Facebook sign in.** Sign in with facebook ability allows your site visitors to register through their social Facebook accounts. The Facebook sign and sign up is set by creating a facebook application through https://developers.facebook.com/ after having Facebook app ID and Secret codes you enable the function in the popup.
...
**Custom sign Menu** is a pro feature adds the ability which allows to manage your menu by changing the links of your account or adding new sections, the options are available under General settings.
...
1.  [WordPress](https://huge-it.com/wordpress-login-demo-1-login/)
2.  [WordPress](https://huge-it.com/wordpress-login-demo-1-login/)
3.  [WordPress](https://huge-it.com/wordpress-login-demo-1-login/)
4.  [WordPress](https://huge-it.com/wordpress-login-demo-1-login/)
5.  [WordPress](https://huge-it.com/wordpress-login-demo-1-login/)
6.  [WordPress](https://wordpress.org/plugins/login-social/) - admin page
7.  [WordPress](https://wordpress.org/plugins/login-social/) - admin page
8.  [WordPress](https://wordpress.org/plugins/login-social/) - admin page
...
*  You need to use the shortcode, if you like the default option then use the shortcodes for [hg-login-button] and for Sign Up [hg-signup-button].
  	
  	
= May I use this plugin in a widget? =
...
**Plugin in Dashboard page has 3 blocks.**
...
* There are some configurations on sign in button and Popup window
* Button text. Besides defining a custom text for each shortcode you may also change the name on the button from this option 
* Popup Title. The popup on sign in Page may have the title. Text of the title can be changed from this part
* Popup Subtitle. Write any text for subtitle, and leave it blank to not have any subtitles
...
The section is for connection of your plugin with facebook application which allows to sign up and sign the account from facebook acount of the user
...
Button also may be designed from the colors, you may change the color of following parts:
...
And change the font size of Button text from option: 
...
* We have added Google Plus option.
...
* Meet the new custom plugin for WordPress.